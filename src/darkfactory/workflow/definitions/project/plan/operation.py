"""Plan project operation — decompose an epic or feature PRD into child task PRDs.
...
execution for undecomposed PRDs), this *project operation* is driven
...
operation = ProjectOperation(
    ...
    pr_body=(
        "Auto-generated by `prd project run plan --target {target_prd}`.\n\n"
