...
from .loader import load_operations, load_workflows
from .prd import (
    PRD,
    PRD_ID_RE,
    dump_frontmatter,
...
from .system_runner import run_system_operation
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.operations_dir is None:
        if darkfactory_dir is not None:
            args.operations_dir = darkfactory_dir / "operations"
        else:
            # prd_dir was provided explicitly — derive operations_dir from it.
