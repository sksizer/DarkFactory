...
def test_children(tmp_prd_dir: Path) -> None:
    ...
    write_prd(tmp_prd_dir / "prds", "PRD-010", "feat-a", parent="PRD-001")
    write_prd(tmp_prd_dir / "prds", "PRD-011", "feat-b", parent="PRD-001")
    write_prd(tmp_prd_dir / "prds", "PRD-020", "other-feat", parent=None)
...
def test_descendants_recurses(tmp_prd_dir: Path) -> None:
    write_prd(tmp_prd_dir / "prds", "PRD-001", "epic", kind="epic")
    write_prd(tmp_prd_dir / "prds", "PRD-010", "feat", kind="feature", parent="PRD-001")
    write_prd(tmp_prd_dir / "prds", "PRD-070", "task-a", kind="task", parent="PRD-010")
    write_prd(tmp_prd_dir / "prds", "PRD-071", "task-b", kind="task", parent="PRD-010")
    prds = load_all(tmp_prd_dir)
...
def test_ancestors_walks_up(tmp_prd_dir: Path) -> None:
    write_prd(tmp_prd_dir / "prds", "PRD-001", "epic", kind="epic")
    write_prd(tmp_prd_dir / "prds", "PRD-010", "feat", kind="feature", parent="PRD-001")
    write_prd(tmp_prd_dir / "prds", "PRD-070", "task", kind="task", parent="PRD-010")
    prds = load_all(tmp_prd_dir)
...
def test_roots(tmp_prd_dir: Path) -> None:
    write_prd(tmp_prd_dir / "prds", "PRD-001", "epic1", kind="epic")
    write_prd(tmp_prd_dir / "prds", "PRD-002", "epic2", kind="epic")
    write_prd(tmp_prd_dir / "prds", "PRD-010", "feat", kind="feature", parent="PRD-001")
    prds = load_all(tmp_prd_dir)
...
def test_is_fully_decomposed_true(tmp_prd_dir: Path) -> None:
    write_prd(tmp_prd_dir / "prds", "PRD-001", "epic", kind="epic")
    write_prd(tmp_prd_dir / "prds", "PRD-070", "task", kind="task", parent="PRD-001")
    prds = load_all(tmp_prd_dir)
